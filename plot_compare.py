...
with open(vul_1_data, 'rb') as handle_1:
    vul_1_data = pickle.load(handle_1)

with open(vul_2_data, 'rb') as handle_2:
    vul_2_data = pickle.load(handle_2)

color_index = 0
vulcan_1_spec = vul_1_data['variable']['species']
vulcan_2_spec = vul_2_data['variable']['species']
...
if use_height == False:
    ...
    plt.ylim((vul_1_data['atm']['pco'][0]/1e6,vul_1_data['atm']['pco'][-1]/1e6))
